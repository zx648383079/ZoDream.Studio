...
namespace 弹琴
{
    ...
    public class MidiBase
    {
        ...
        public void SendMesssage(UInt32 dwMsg)
        {
            if (isOpen)
            {
                midiOutShortMsg(lphMidiOut, dwMsg);
            }
        }
        /// <summary>
        /// 按键按下
        ...
        public void KeyDown(byte chn,byte vol,byte scl)
        {
            var x = volume * 65536 + scl * 256 + chn + 144;
            SendMesssage((UInt32)x);
        }
        /// <summary>
        /// 按键按下
        /// </summary>
        /// <param name="scl">音阶</param>
        public void KeyDown(byte scl)
        {
            KeyDown(0, volume, scl);
        }
        /// <summary>
        /// 按键按下
        /// </summary>
        /// <param name="chn">频道</param>
        /// <param name="scl">音阶</param>
        public void KeyDown(byte chn,byte scl)
        {
            KeyDown(chn, volume, scl);
        }
        /// <summary>
        /// 取消发音
        /// </summary>
        /// <param name="chn">频道</param>
        /// <param name="scl">音阶</param>
        public void KeyUp(byte chn,byte scl)
        {
        ...
        /// <param name="chn">频道</param>
        public void SetTimber(byte timber,byte chn)
        {
            var x = timber * 256 + 192 + chn;
            SendMesssage((UInt32)x);
        }
        ...
        /// </summary>
        /// <param name="timber">音色</param>
        public void SetTimber(byte timber)
        {
            SetTimber(timber, 0);
        }
    }
